<div id="slider1_container" style="position: relative; width: 450px; height: 330px;margin-bottom: 10px;">
        ...
        <!-- Slides Container -->
        <div u="slides" style="position: absolute; left: 0px; top: 0px; width: 480px; height: 330px;overflow: hidden;">
            <?php
